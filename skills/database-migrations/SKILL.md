...
project_types: [any]
when_to_use: |
  Planning database schema changes, implementing zero-downtime migrations, setting up migration tooling, troubleshooting migration issues, or reviewing migration pull requests.
cost_tokens: 11000
---
