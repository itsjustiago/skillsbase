...
tags: [security, supply-chain, dependencies, audit, risk-assessment]
project_types: [any]
when_to_use: "Assessing dependency risk before a security audit, evaluating supply chain attack surface of a project, identifying unmaintained or risky dependencies, or pre-engagement scoping for supply chain concerns."
cost_tokens: 3200
allowed-tools:
  - Read
  - Write
