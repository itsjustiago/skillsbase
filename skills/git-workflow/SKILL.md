...
project_types: [any]
when_to_use: |
  Setting up Git workflow for a new project, deciding on branching strategy, writing commit messages and PR descriptions, resolving merge conflicts, managing releases, or onboarding new team members.
cost_tokens: 16000
---
