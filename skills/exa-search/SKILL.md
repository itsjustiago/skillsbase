---
name: exa-search
description: Neural search via Exa MCP for web, code, companies, and people. Access current information, code examples, technical references, and business intelligence.
tags:
  - search
  - research
  - mcp
...
project_types:
  - any
when_to_use: When the user needs current web information, code examples, company research, people lookup, or background research that requires real-time or recent data.
cost_tokens: 1250
---
