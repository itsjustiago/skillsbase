---
name: blog-post
description: Long-form article/blog post — masthead, hero image, article body with pull quotes, author byline, related posts. Use for blog articles, essays, case studies, newsletters.
tags:
  - html
  - design
  - blog
...
project_types:
  - any-web
when_to_use: |
  When the brief asks for a blog post, article, essay, case study, or newsletter. Produces an editorial long-form page with typography-driven layout, hero image, and related articles section.
cost_tokens: 205
triggers:
  - "blog"
  - "blog post"
