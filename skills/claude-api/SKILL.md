---
name: claude-api
description: Build Claude API applications in Python and TypeScript. Covers Messages API, streaming, tool use, vision, extended thinking, batches, prompt caching, and Agent SDK patterns.
tags:
  - claude-api
  - anthropic
  - llm
...
project_types:
  - any
when_to_use: When building or debugging Claude API applications, optimizing token usage, implementing tool use or agents, or selecting models for cost/speed tradeoffs.
cost_tokens: 2200
---
