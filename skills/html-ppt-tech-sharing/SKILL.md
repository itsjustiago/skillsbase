...
description: Conference/tech-talk HTML deck — GitHub-dark, JetBrains Mono, terminal code blocks, agenda + Q&A pages. Use for engineering talks and technical presentations.
tags:
  - html
  - presentation
  - deck
...
project_types:
  - any-web
when_to_use: |
  When the brief asks for a tech talk, engineering presentation, conference talk, or technical sharing. Produces an HTML deck with code blocks, dark theme, and code-friendly layouts.
cost_tokens: 190
triggers:
  - "tech sharing"
  - "tech talk"
