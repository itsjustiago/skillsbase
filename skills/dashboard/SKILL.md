---
name: dashboard
description: Admin/analytics dashboard in single HTML file — left sidebar nav, top bar with search, KPI cards, charts. Use when brief asks for dashboard, admin panel, analytics, or control panel.
tags:
  - html
  - design
  - dashboard
...
project_types:
  - any-web
when_to_use: |
  When the brief asks for an admin interface, analytics dashboard, control panel, or operations monitoring screen. Produces a single-screen layout with KPI cards and charts.
cost_tokens: 71
triggers:
  - "dashboard"
  - "admin panel"
