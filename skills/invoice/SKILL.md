---
name: invoice
description: Printable invoice page — sender/recipient blocks, line items table, tax breakdown, totals, payment instructions. Use for billing documents and invoices.
tags:
  - html
  - design
  - invoice
...
project_types:
  - any-web
when_to_use: |
  When the brief asks for an invoice, bill, billing statement, or financial document. Produces a printable single-page invoice with sender/recipient info, line items, and totals.
cost_tokens: 123
triggers:
  - "invoice"
  - "bill"
