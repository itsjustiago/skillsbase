...
description: Generate hand-drawn wireframe sketches with graph-paper background, marker tones, and lo-fi annotation—perfect for early-stage design exploration.
tags:
  - wireframe
  - low-fidelity
  - mockup
...
project_types:
  ...
  - any
when_to_use: |
  Trigger when the user explicitly asks for wireframes, sketches, lo-fi mockups, or hand-drawn prototypes. Use during discovery and early design phases to explore layout and information hierarchy without committing to visual polish.
cost_tokens: 1700
---
