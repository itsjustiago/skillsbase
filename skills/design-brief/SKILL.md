---
name: design-brief
description: Parse natural-language design briefs into structured specs using I-Lang protocol—eliminate ambiguity with explicit palette, typography, layout, mood, and density.
tags:
  - design
  - brief
  - planning
...
project_types:
  ...
  - any
when_to_use: |
  Trigger when the user needs a structured design brief or design system specification. Use at the start of a project or when clarifying vague requirements like "make it professional"—this skill converts natural language into explicit design dimensions and tokens.
cost_tokens: 5700
---
