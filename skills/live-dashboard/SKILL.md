---
name: live-dashboard
description: Notion-style team dashboard — KPIs, 7-day sparkline, activity feed, linked-database table. Wired to Notion via connectors. Falls back to mock data offline.
tags:
  - html
  - design
  - dashboard
...
project_types:
  - any-web
when_to_use: |
  When the brief asks for a team dashboard, Notion dashboard, operations dashboard, or live-updating workspace view. Produces a single-page HTML dashboard with real-time data binding.
cost_tokens: 475
triggers:
  - "team dashboard"
  - "notion dashboard"
