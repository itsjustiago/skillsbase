---
name: saas-landing
description: Single-page SaaS landing — hero, features, social proof, pricing, footer CTA. Respects active DESIGN.md tokens. Use for product landing pages and marketing sites.
tags:
  - html
  - design
  - landing-page
...
project_types:
  - any-web
when_to_use: |
  When the brief asks for a SaaS landing page, marketing page, or product landing. Produces a scrollable single-page site with hero, features, proof section, optional pricing, and CTA band.
cost_tokens: 468
triggers:
  - "saas landing"
  - "marketing page"
