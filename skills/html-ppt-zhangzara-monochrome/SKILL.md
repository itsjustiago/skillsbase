...
description: Monochrome HTML deck — ivory ledger paper, all-black type, Lora serif headlines. Use for white papers, user research, academic briefs, policy documents.
tags:
  - html
  - presentation
  - deck
...
project_types:
  - any-web
when_to_use: |
  When the brief asks for a monochrome, restrained, or literary deck; white papers; user research synthesis; academic briefs; or policy documents. Produces a minimalist HTML presentation with serif type and no color.
cost_tokens: 290
triggers:
  - "monochrome"
