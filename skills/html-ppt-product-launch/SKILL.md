...
description: Launch keynote HTML deck — dark hero + light content, warm orange→peach accent, feature cards, pricing tiers, CTA. Use for product announcements and feature reveals.
tags:
  - html
  - presentation
  - deck
...
project_types:
  - any-web
when_to_use: |
  When the brief asks for a product launch, keynote, feature reveal, or launch deck. Produces an HTML presentation with dark hero sections and warm accent colors.
cost_tokens: 183
triggers:
  - "product launch"
  - "keynote"
