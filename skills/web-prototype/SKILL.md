---
name: web-prototype
description: General-purpose desktop web prototype — single self-contained HTML file built from seed template + section layouts. Default for landing/marketing/docs pages.
tags:
  - html
  - design
  - prototype
...
project_types:
  - any-web
when_to_use: |
  When the brief asks for a landing page, marketing page, homepage, or prototype and no more specific skill matches. Produces a single self-contained HTML prototype using bundled seed and layout library.
cost_tokens: 312
triggers:
  - "prototype"
  - "mockup"
