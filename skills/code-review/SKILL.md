...
project_types: [any]
when_to_use: |
  Reviewing pull requests, analyzing code quality, identifying issues, generating review checklists, or automating code review workflows across TypeScript, JavaScript, Python, Go, Swift, and Kotlin projects.
cost_tokens: 3500
---
...
- Identifying issues and code smells
