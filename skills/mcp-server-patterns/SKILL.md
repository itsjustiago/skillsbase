...
description: Build MCP servers with Node/TypeScript SDK. Tools, resources, prompts, Zod validation, stdio vs Streamable HTTP transport options.
tags:
  - mcp
  - typescript
  - agents
...
project_types:
  - any
when_to_use: When building or maintaining MCP servers, adding tools or resources, choosing transport layers, upgrading the SDK, or debugging MCP registration.
cost_tokens: 985
---
