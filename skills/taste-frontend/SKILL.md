---
name: taste-frontend
description: Anti-slop frontend para landings, portfolios e redesigns — 3 diais, bans explicitos e pre-flight check contra UI generica de IA. Nao serve dashboards nem produto multi-ecra.
tags: [design, frontend, landing-page, tailwind, nextjs, motion, typography, anti-slop, taste]
project_types: [nextjs, any-web]
when_to_use: |
  Usa ao construir ou redesenhar landing pages, sites de marketing e portfolios
  (Elevia, Toolbelt e afins). Le o brief, ajusta 3 diais (variance/motion/density)
  e impoe regras concretas: max 1 cor de destaque <80% saturacao, hero dentro do
  viewport, motion so com justificacao, ban de em-dash e de paletas default.
  NAO usar em dashboards, tabelas de dados ou UI de produto multi-step (Cockpit,
  apps) — a skill exclui esse ambito explicitamente.
  Origem: github.com/Leonxlnx/taste-skill (v2, 67.9k stars, jul/2026).
cost_tokens: 21800
---
