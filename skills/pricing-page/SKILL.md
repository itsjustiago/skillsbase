---
name: pricing-page
description: Standalone pricing page — header, plan tiers with pricing, feature comparison table, FAQ. Use for pricing pages, subscription plans, tier comparisons.
tags:
  - html
  - design
  - pricing
...
project_types:
  - any-web
when_to_use: |
  When the brief asks for a pricing page, subscription tiers, or plan comparison. Produces a full-page pricing layout with 2-4 tier cards, feature matrix, and FAQ section.
cost_tokens: 250
triggers:
  - "pricing"
  - "pricing page"
