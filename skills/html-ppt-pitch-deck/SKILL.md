...
description: Investor-ready 10-slide HTML pitch deck — white + blue→purple gradient hero, big numbers, traction bar chart, ask page. Use for seed-round pitches and VC fundraising.
tags:
  - html
  - presentation
  - deck
...
project_types:
  - any-web
when_to_use: |
  When the brief asks for a pitch deck, fundraising deck, seed-round pitch, or investor deck. Produces a 10-slide HTML presentation with hero gradient, financial data visualization, and funding ask.
cost_tokens: 190
triggers:
  - "pitch deck"
  - "pitch"
