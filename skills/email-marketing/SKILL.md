...
description: Brand product-launch email — masthead, hero block, headline lockup, body copy, CTA, specs grid. Pure HTML email layout (600px column). Use for email templates and newsletter blasts.
tags:
  - html
  - design
  - email
...
project_types:
  - any-web
when_to_use: |
  When the brief asks for an email template, newsletter blast, product launch email, or MJML email. Produces a single-column HTML email optimized for email clients.
cost_tokens: 271
triggers:
  - "email"
  - "email template"
