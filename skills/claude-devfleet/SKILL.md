...
tags: [agent, agents, harness, deployment]
project_types: [any]
when_to_use: |
  Dispatching multiple Claude Code agents to work on coding tasks in parallel. Each agent runs in an isolated git worktree with full tooling. Requires a running DevFleet instance connected via MCP.
cost_tokens: 3200
---
