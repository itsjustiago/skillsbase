...
echo ""
echo "  2. (Optional) Extra MCPs + CLIs — design tooling, graphify, browser-harness:"
echo "       see setup/install-extras.md"
echo ""
echo "  3. MCP authentication (supabase, vercel, github token, etc.):"
echo "       see mcp/README.md"
echo ""
